...
mv $SRC/gdal_fuzzer.cpp $SRC/gdal/fuzzers/
...
sed -i "79i << _COMMENT_OUT" $SRC/gdal/fuzzers/build_google_oss_fuzzers.sh
sed -i "120i _COMMENT_OUT" $SRC/gdal/fuzzers/build_google_oss_fuzzers.sh
